...
public class UserConverter {
	public User createDatabaseUser(leo.prj.petrocoin.bean.backobject.User user) {
	...
	public User createUpdateDatabaseUser(leo.prj.petrocoin.bean.backobject.User user) {
		return this.createDatabaseUser(user).setId(user.getId());
	}

	public leo.prj.petrocoin.bean.backobject.User createUser(User user) {
		leo.prj.petrocoin.bean.backobject.User userBean = new leo.prj.petrocoin.bean.backobject.User();
